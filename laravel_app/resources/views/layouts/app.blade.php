...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* Auth ekrani ile ayni iki ton lacivert */
            --navy-deep: #0a0f18;
            --navy-left: #1a3358;
        ...
        * { box-sizing: border-box; }
        ...
        .app-sidebar::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(120% 80% at 0% 0%, rgba(59, 130, 246, 0.12), transparent 55%);
            pointer-events: none;
        }
        .sidebar-header {
            position: relative;
        ...
        td { font-size: 13px; color: var(--txt); font-weight: 500; }
        ...
        .insight-card--amber {
            ...
            box-shadow:
                ...
                0 4px 20px rgba(217, 119, 6, 0.22);
        }
        .insight-card--amber:hover {
            ...
            box-shadow:
                ...
                0 10px 28px rgba(217, 119, 6, 0.28);
        }
        .insight-card--teal {
            ...
            box-shadow:
                0 2px 10px rgba(15, 23, 42, 0.08),
                0 4px 20px rgba(13, 148, 136, 0.22);
        }
        ...
        .insight-card--purple {
            ...
            box-shadow:
                0 2px 10px rgba(15, 23, 42, 0.08),
                0 4px 20px rgba(124, 58, 237, 0.22);
        }
        ...
        .insight-card--gray {
            ...
            box-shadow:
                0 2px 10px rgba(15, 23, 42, 0.08),
                0 4px 20px rgba(75, 85, 99, 0.18);
        }
        .insight-card--gray:hover {
            ...
            box-shadow:
                0 4px 12px rgba(15, 23, 42, 0.1),
                0 10px 28px rgba(75, 85, 99, 0.22);
        }
        .insight-card__icon {
            flex-shrink: 0;
            width: 32px;
        ...
        .insight-card--gray .insight-card__icon {
            background: #9ca3af;
            color: #374151;
        }
        .insight-card__body {
            ...
            <aside class="app-sidebar" aria-label="Main navigation">
                ...
                <div class="sidebar-bottom">
                    <div class="sidebar-actions">
                        <a href="{{ route('profile.show') }}" class="sidebar-icon-link {{ request()->routeIs('profile.*') ? 'sidebar-icon-link--active' : '' }}" title="Settings" aria-label="Settings">
